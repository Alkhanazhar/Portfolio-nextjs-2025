...
export function Hero() {
  return (
    <div className="flex items-center justify-center w-full flex-col px-4 mt-16 -z-10 space-y-8 md:space-y-4">
      ...
      >
        <div className="w-4 h-4 rounded-full bg-[#6abe5e]"></div> Available for
        opportunities
      </motion.div>
      <div className="overflow-hidden">
        <motion.h2
          ...
          className=" bg-clip-text text-transparent text-center bg-gradient-to-b from-neutral-900 to-neutral-700 dark:from-neutral-400 dark:to-white text-2xl md:text-4xl lg:text-7xl font-sans py-2 md:py-10 relative z-20 font-bold tracking-tight"
        >
          Hello {"i'am"} Azhar Khan. <br />
